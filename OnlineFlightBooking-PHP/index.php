...
<link rel="stylesheet" type="text/css"
	...
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollВ(0,1); } ;</script>	
	<div class="main-agileinfo">
		<h1 class="text-light brand mt-2">
			<img src="assets/images/airtic.png" 
				height="105px" width="105px" alt="">				
		Бронирование авибилетов</h1>
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Туда-обратно</span></li>
					<li class="resp-tab-item"><span>В один конец</span></li>
				</ul>	
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								<option value="0" selected disabled >Город вылета</option>';
							...
							<div class="to">
								...
								<option selected disabled>Город назначения</option>';
								while ($row = mysqli_fetch_assoc($result)) {
								echo '<option value='. $row['city']  .'>'. 
									$row['city'] .'</option>';
								}
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Пассажиры</h3>
									<div class="quantity"> 
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								<div class="depart">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Дата вылеты</h3>
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Количество пассажиров</h3>
									<div class="quantity"> 
										<div class="quantity-select">                           
											<div class="entry value-minus">&nbsp;</div>
											<div class="entry value"><span>1</span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Приятные цены</div>
                                            <div class="intro_subtitle"><!-- log on to codeastro.com for more projects -->
                                                <p>Летайте по любимым маршрутам по приятным ценам</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Хороший сервис</div>
                                            <div class="intro_subtitle">
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Бронирование авиабилетов</h5></em>
