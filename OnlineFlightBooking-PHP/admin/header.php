...
<html lang="en">
    <head>
        ...
        <title>Бронирование авибилетов</title>          
        <link rel = "icon" href =  
  ...
  h4 {
    ...
    <body>
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse"
            ...
            aria-expanded="false" aria-label="Вggle navigation">
                  ...
                  <li class="nav-item">
                    <div class="dropdown mt-2">
                      <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                        ...
                        <i class="fa fa-plus text-white"></i> Авиакомпанияs </td>
                      </button>  
                        ...
                        <form class="px-2 py-2"  action="../includes/admin/airline.inc.php" method="post">
                          <div class="form-group">
                            <input type="text" class="form-control" name="airline" 
                              placeholder="Авиакомпанияs Name">
                            <input type="number" class="form-control mt-3" name="seats" 
                              placeholder="Вtal Seats">                              
                          </div>  
