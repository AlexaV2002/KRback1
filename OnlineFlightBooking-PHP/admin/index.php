...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Вday's Flights</a>
              <a class="dropdown-item" href="#issue">Вday's flight issues</a>
              <a class="dropdown-item" href="#dep">Flights departed today</a>
              <a class="dropdown-item" href="#arr">Flights arrived today</a>
            </div>
          </div>        
        <p class="text-secondary">Вday's Flights</p>
    ...
    <div class="card" id="issue">
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Вday's flight</a>
              <a class="dropdown-item" href="#issue">Вday's flight issues</a>
              <a class="dropdown-item" href="#dep">Flights departed today</a>
              <a class="dropdown-item" href="#arr">Flights arrived today</a>
            </div>
          </div>        
        <p class="text-secondary">Вday's Flight Issues</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Flights Departed Вday</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Flights Arrived Вday</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
