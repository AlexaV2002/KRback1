...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">ОПЛАТА</h1>
            ...
            <div class="icon-container">
              ...
              <i class="fa fa-cc-mir fa-3x" style="color:orange;"></i>
            </div>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="row">
                    ...
                    <div class="col-6 p-0">
                        <label for="x_card_code" class="control-label mb-1">CVV/CVC</label>
                        <div class="row">
                            <div class="col pr-0">
                ...
                <div class='col-md-12 mb-2'>
                    ...
                    class="btn btn-lg btn-primary btn-block">
                        ...
                        <span id="payment-button-amount">Оплата</span>
